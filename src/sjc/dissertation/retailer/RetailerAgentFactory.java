...
public class RetailerAgentFactory {
	...
	private Set<RetailBranch> retailers;
	...
	private RetailerAgentFactory(){
		this.retailers = new HashSet<RetailBranch>(5);
	}

	public RetailerAgent createNewAgent(final RetailBranch brainlessRetailer, final Algorithm policy){
	 ...
	 */
	private boolean retailerInUse(final RetailBranch retailer){
