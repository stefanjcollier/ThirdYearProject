...
public class RetailerAgentFactory {
	...
	private RetailerAgentFactory(){
		this.retailers = new HashSet<Branch>(5);
	}

	public RetailerAgent createNewAgent(final Branch brainlessRetailer, final Algorithm policy){
